...
export function AreaChart({
  ...
  const W = 760;
  const H = 240;
  const padL = 40; // left gutter so the y-axis labels sit beside (not over) the plot
  const padR = 12;
  const padT = 14;
  const padB = 8;
  ...
  return (
    <div className="relative w-full" style={{ height }}>
      ...
      <div className="pointer-events-none absolute inset-y-0 left-0 flex w-9 flex-col justify-between py-[14px] pr-2 text-right text-[10px] text-muted">
